...
addCtrl.controller('addCtrl', function($scope, $http, $rootScope, geolocation, gservice){
    ...
    // Set initial coordinates to the center of the tlv
    $scope.formData.longitude = 32.085300;
    $scope.formData.latitude = 34.781768;
